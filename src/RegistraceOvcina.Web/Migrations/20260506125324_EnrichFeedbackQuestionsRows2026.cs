...
""";
        ...
        {
            // No-op rollback: the previous migration's content is identical aside
            // from the rows hint, and clearing the columns would lose live data
            // for organizers. Down() is best-effort here.
        }
    }
}
